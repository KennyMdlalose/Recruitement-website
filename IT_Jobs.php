                ...
                <p>
                    ...
                    if ($result && mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)) {
                            // Define styles
                            $labelStyle = 'font-weight: bold; text-decoration: underline; text-align: center; font-size: 16px;';
                            $itemStyle = 'text-align: center; font-size: 16px;';
                            $containerStyle = 'border: 1px solid #ccc; padding: 20px; margin-bottom: 20px; border-radius: 10px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);';

                            echo '<div class="job-container" style="'.$containerStyle.'">';  // Start container div
    ...
    <footer class="footer">
        <section class="grid">
            ...
            <div class="box">
                ...
                <a href="https://www.instagram.com/mictseta/?hl=en"><i class="fab fa-instagram"></i>Instagram</a>
