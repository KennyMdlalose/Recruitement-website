...
$result = mysqli_query($conn, "SELECT * FROM workexperience,reference");
...
<section  style="margin-left:-100px;">
        <div class="container">
        <h1>View Work Experience </h1>
        <form action="workExperience.php" method="POST" >
...
if ($result && mysqli_num_rows($result) > 0) {
   while( $row = mysqli_fetch_assoc($result)){ 
    ...
    echo '<tr><td>Company Name:</td><td>' . htmlspecialchars($row['company']) . '</td></tr>';
    echo '<tr><td>Position:</td><td>' . htmlspecialchars($row['position']) . '</td></tr>';
    echo '<tr><td>Industry:</td><td>' . htmlspecialchars($row['industry']) . '</td></tr>';
    echo '<tr><td>Previous Salary Range:</td><td>' . htmlspecialchars($row['salary']) . '</td></tr>';
    echo '<tr><td>Reason For Leaving:</td><td>' . htmlspecialchars($row['reasonleaving']) . '</td></tr>';
    echo '<tr><td>Location:</td><td>' . htmlspecialchars($row['location']) . '</td></tr>';
    echo '<tr><td>Start Date:</td><td>' . htmlspecialchars($row['startDate']) . '</td></tr>';
    echo '<tr><td>End Date:</td><td>' . htmlspecialchars($row['endDate']) . '</td></tr>';
    ...
    echo '<tr><td>Reference:</td><td>' . htmlspecialchars($row['referenceName']) . '</td></tr>';
    echo '<tr><td>Relationship:</td><td>' . htmlspecialchars($row['relationship']) . '</td></tr>';
    echo '<tr><td>Years Acquanted:</td><td>' . htmlspecialchars($row['years']) . '</td></tr>';
    echo '<tr><td>Phone Number:</td><td>' .'+27 ' . htmlspecialchars($row['phoneNumber']) . '</td></tr>';
