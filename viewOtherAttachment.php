...
<section  style="margin-left:-100px;">
        ...
        <form action="otherAttachments.php" method="POST" >
...
if ($result && mysqli_num_rows($result) > 0) {
   while($row = mysqli_fetch_assoc($result)){ 
    ...
    echo '<tr><td>Curriculum vitae: </td><td>' . htmlspecialchars($row[' ']) . '</td></tr>';
    echo '<tr><td>ID:</td><td>' . htmlspecialchars($row[' ']) . '</td></tr>';
    echo '<tr><td>Additional Document:</td><td>' . htmlspecialchars($row[' ']) . '</td></tr>';
