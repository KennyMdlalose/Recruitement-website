...
$result = mysqli_query($conn, "SELECT * FROM softskills");
?>
<!DOCTYPE html>
<html lang = "en">
    <head>
...
<section  style="margin-left:-100px;">
        <div class="container">
        <h1>View Soft Skills </h1>
        <form action="softSkills.php" method="POST" >
...
if ($result && mysqli_num_rows($result) > 0) {
  while ( $row = mysqli_fetch_assoc($result) ){
    ...
    echo '<tr><td>Your Soft Skills:</td><td>' . htmlspecialchars($row['skills']) . '</td></tr>';
    echo '<tr><td>How proficient are you:</td><td>' . htmlspecialchars($row['rating']) . '</td></tr>';
    echo '<tr><td>Other Soft Skills:</td><td>' . htmlspecialchars($row['otherSkills']) . '</td></tr>';
...
<div class="button-container">
    <input type="submit" value="Back"  style="width: 100px;margin-left:10px;"  onclick="window.location.href='editSoftSkills.php';">
